    ...
    <motion.div className="relative outline-none focus:outline-none" animate={value} initial={false}>
      <motion.div
        ...
        {value === StepValue.COMPLETE ? (
          <CheckIcon data-testid="complete-indicator" className="h-4 w-4 dark:text-black text-white" />
        ) : value === StepValue.ACTIVE ? (
          <div data-testid="active-indicator" className="h-3 w-3 rounded-full dark:bg-[#060606] bg-[#f5f5f5]" />
        ) : (
